...
SET DOCOUT=labs-javadoc.out
SET DOCERR=labs-javadoc.err
SET MAINCLASSSRC=src/battleship/Launcher.java
SET MAINCLASSBIN=battleship.Launcher
SET JAVAVERSION=20
...
:: copying jar file to main folder assuming that is where the graphics are
COPY %BINDIR%\%JARNAME% .\
